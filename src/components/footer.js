      ...
      <div className="w-full h-full flex flex-col justify-center items-center bg-black/30">
        <div className=" w-full max-w-[1600px] flex flex-col justify-between items-center p-16 gap-4 md:flex-row sd:">
          <div className="flex flex-col md:items-start items-center">
            <h2 className="font-semibold text-xl text-center md:text-start mb-4">
              Maalaustoimi Hytönen & Eskola Oy
            </h2>
            <p className=" text-center md:text-start">Y-tunnus 3344645-5</p>
            <p className="text-center md:text-start">
              Ainolantie 19 as. 12, 41800 Korpilahti
            </p>
            <Link className="text-center md:text-start" href="tel:0442743255">
              044 274 3255
            </Link>
          </div>
          ...
          <div className="">
            <Link
              href="https://www.instagram.com/maalaustoimi"
        ...
        <div>
          <p>© 2024 Maalaustoimi Hytönen & Eskola Oy</p>
        </div>
      </div>
    </div>
  );
